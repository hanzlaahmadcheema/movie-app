...
document.addEventListener('DOMContentLoaded', () => {
  ...
  const apkDownloadUrl = 'https://github.com/hanzlaahmadcheema/movie-app/releases/download/v1.16.2/app-release.apk';
  ...
  downloadBtns.forEach(btn => {
    btn.addEventListener('click', () => {
      showToast('Downloading HA MovieApp v1.16.2 APK...');
    });
  });
